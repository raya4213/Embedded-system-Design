   ...
   0000                     445 	.ds 8
                            ...
                            468 ;--------------------------------------------------------
                            469 	.area XSEG    (XDATA)
   0400                     470 _delay_us_us_count_1_1:
   0400                     471 	.ds 2
   0402                     472 _delay_ms_ms_count_1_1:
   0402                     473 	.ds 2
   0404                     474 _delay_s_s_count_1_1:
   0404                     475 	.ds 2
                            476 ;--------------------------------------------------------
   ...
   00D3                     515 _delay_us:
                    ...
                    0001    523 	ar1 = 0x01
                            524 ;	genReceive
   00D3 AA 83               525 	mov	r2,dph
   00D5 E5 82               526 	mov	a,dpl
   00D7 90 04 00            527 	mov	dptr,#_delay_us_us_count_1_1
   00DA F0                  528 	movx	@dptr,a
   00DB A3                  529 	inc	dptr
   00DC EA                  530 	mov	a,r2
   00DD F0                  531 	movx	@dptr,a
                            532 ;	delay.c:11: while(us_count!=0)
                            533 ;	genAssign
   00DE 90 04 00            534 	mov	dptr,#_delay_us_us_count_1_1
   00E1 E0                  535 	movx	a,@dptr
   00E2 FA                  536 	mov	r2,a
   00E3 A3                  537 	inc	dptr
   00E4 E0                  538 	movx	a,@dptr
   00E5 FB                  539 	mov	r3,a
   00E6                     540 00101$:
                            541 ;	genCmpEq
                            542 ;	gencjneshort
   00E6 BA 00 05            543 	cjne	r2,#0x00,00109$
   00E9 BB 00 02            544 	cjne	r3,#0x00,00109$
                            545 ;	Peephole 112.b	changed ljmp to sjmp
   00EC 80 0F               546 	sjmp	00108$
   00EE                     547 00109$:
                            548 ;	delay.c:13: us_count = us_count -1;
                            549 ;	genMinus
                            550 ;	genMinusDec
   00EE 1A                  551 	dec	r2
   00EF BA FF 01            552 	cjne	r2,#0xff,00110$
   00F2 1B                  553 	dec	r3
   00F3                     554 00110$:
                            555 ;	genAssign
   00F3 90 04 00            556 	mov	dptr,#_delay_us_us_count_1_1
   00F6 EA                  557 	mov	a,r2
   00F7 F0                  558 	movx	@dptr,a
   00F8 A3                  559 	inc	dptr
   00F9 EB                  560 	mov	a,r3
   00FA F0                  561 	movx	@dptr,a
                            562 ;	Peephole 112.b	changed ljmp to sjmp
   00FB 80 E9               563 	sjmp	00101$
   00FD                     564 00108$:
                            565 ;	genAssign
   00FD 90 04 00            566 	mov	dptr,#_delay_us_us_count_1_1
   0100 EA                  567 	mov	a,r2
   0101 F0                  568 	movx	@dptr,a
   0102 A3                  569 	inc	dptr
   0103 EB                  570 	mov	a,r3
   0104 F0                  571 	movx	@dptr,a
   ...
   0106                     583 _delay_ms:
                            584 ;	genReceive
   0106 AA 83               585 	mov	r2,dph
   0108 E5 82               586 	mov	a,dpl
   010A 90 04 02            587 	mov	dptr,#_delay_ms_ms_count_1_1
   010D F0                  588 	movx	@dptr,a
   010E A3                  589 	inc	dptr
   010F EA                  590 	mov	a,r2
   0110 F0                  591 	movx	@dptr,a
                            592 ;	delay.c:19: while(ms_count!=0)
                            593 ;	genAssign
   0111 90 04 02            594 	mov	dptr,#_delay_ms_ms_count_1_1
   0114 E0                  595 	movx	a,@dptr
   0115 FA                  596 	mov	r2,a
   0116 A3                  597 	inc	dptr
   0117 E0                  598 	movx	a,@dptr
   0118 FB                  599 	mov	r3,a
   0119                     600 00101$:
                            601 ;	genCmpEq
                            602 ;	gencjneshort
   0119 BA 00 05            603 	cjne	r2,#0x00,00109$
   011C BB 00 02            604 	cjne	r3,#0x00,00109$
                            605 ;	Peephole 112.b	changed ljmp to sjmp
   011F 80 1D               606 	sjmp	00108$
   0121                     607 00109$:
                            608 ;	delay.c:21: delay_us(112);
                            609 ;	genCall
                            610 ;	Peephole 182.b	used 16 bit load of dptr
   0121 90 00 70            611 	mov	dptr,#0x0070
   0124 C0 02               612 	push	ar2
   0126 C0 03               613 	push	ar3
   0128 12 00 D3            614 	lcall	_delay_us
   012B D0 03               615 	pop	ar3
   012D D0 02               616 	pop	ar2
                            617 ;	delay.c:22: ms_count = ms_count -1;
                            618 ;	genMinus
                            619 ;	genMinusDec
   012F 1A                  620 	dec	r2
   0130 BA FF 01            621 	cjne	r2,#0xff,00110$
   0133 1B                  622 	dec	r3
   0134                     623 00110$:
                            624 ;	genAssign
   0134 90 04 02            625 	mov	dptr,#_delay_ms_ms_count_1_1
   0137 EA                  626 	mov	a,r2
   0138 F0                  627 	movx	@dptr,a
   0139 A3                  628 	inc	dptr
   013A EB                  629 	mov	a,r3
   013B F0                  630 	movx	@dptr,a
                            631 ;	Peephole 112.b	changed ljmp to sjmp
   013C 80 DB               632 	sjmp	00101$
   013E                     633 00108$:
                            634 ;	genAssign
   013E 90 04 02            635 	mov	dptr,#_delay_ms_ms_count_1_1
   0141 EA                  636 	mov	a,r2
   0142 F0                  637 	movx	@dptr,a
   0143 A3                  638 	inc	dptr
   0144 EB                  639 	mov	a,r3
   0145 F0                  640 	movx	@dptr,a
   ...
   0147                     652 _delay_s:
                            653 ;	genReceive
   0147 AA 83               654 	mov	r2,dph
   0149 E5 82               655 	mov	a,dpl
   014B 90 04 04            656 	mov	dptr,#_delay_s_s_count_1_1
   014E F0                  657 	movx	@dptr,a
   014F A3                  658 	inc	dptr
   0150 EA                  659 	mov	a,r2
   0151 F0                  660 	movx	@dptr,a
                            661 ;	delay.c:29: while(s_count!=0)
                            662 ;	genAssign
   0152 90 04 04            663 	mov	dptr,#_delay_s_s_count_1_1
   0155 E0                  664 	movx	a,@dptr
   0156 FA                  665 	mov	r2,a
   0157 A3                  666 	inc	dptr
   0158 E0                  667 	movx	a,@dptr
   0159 FB                  668 	mov	r3,a
   015A                     669 00101$:
                            670 ;	genCmpEq
                            671 ;	gencjneshort
   015A BA 00 05            672 	cjne	r2,#0x00,00109$
   015D BB 00 02            673 	cjne	r3,#0x00,00109$
                            674 ;	Peephole 112.b	changed ljmp to sjmp
   0160 80 1D               675 	sjmp	00108$
   0162                     676 00109$:
                            677 ;	delay.c:31: delay_ms(1000);
                            678 ;	genCall
                            679 ;	Peephole 182.b	used 16 bit load of dptr
   0162 90 03 E8            680 	mov	dptr,#0x03E8
   0165 C0 02               681 	push	ar2
   0167 C0 03               682 	push	ar3
   0169 12 01 06            683 	lcall	_delay_ms
   016C D0 03               684 	pop	ar3
   016E D0 02               685 	pop	ar2
                            686 ;	delay.c:32: s_count = s_count -1;
                            687 ;	genMinus
                            688 ;	genMinusDec
   0170 1A                  689 	dec	r2
   0171 BA FF 01            690 	cjne	r2,#0xff,00110$
   0174 1B                  691 	dec	r3
   0175                     692 00110$:
                            693 ;	genAssign
   0175 90 04 04            694 	mov	dptr,#_delay_s_s_count_1_1
   0178 EA                  695 	mov	a,r2
   0179 F0                  696 	movx	@dptr,a
   017A A3                  697 	inc	dptr
   017B EB                  698 	mov	a,r3
   017C F0                  699 	movx	@dptr,a
                            700 ;	Peephole 112.b	changed ljmp to sjmp
   017D 80 DB               701 	sjmp	00101$
   017F                     702 00108$:
                            703 ;	genAssign
   017F 90 04 04            704 	mov	dptr,#_delay_s_s_count_1_1
   0182 EA                  705 	mov	a,r2
   0183 F0                  706 	movx	@dptr,a
   0184 A3                  707 	inc	dptr
   0185 EB                  708 	mov	a,r3
   0186 F0                  709 	movx	@dptr,a
